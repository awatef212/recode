...
def open_windows_choise():
    ...
    def add_condition():
        ...
        # Met à jour immédiatement le champ 'name_entry' en fonction de la colonne sélectionnée
        update_name_entry(column_cb, name_entry)

        # Liaison de l'événement de sélection dans column_cb
        column_cb.bind("<<ComboboxSelected>>", lambda event: update_name_entry(column_cb, name_entry))
        column_cb.bind("<<ComboboxSelected>>", validate_condition)
